...
export default function App() {
    ...
    useEffect(() => {
        // Preload all tutorial images at app startup
        const preloadImages = [
            '/assets/icons/props/MaxilarLeon/64.png',
            '/assets/images/screenshots/screenshot_npcs_01.png',
            '/assets/images/screenshots/screenshot_npcs_02.png',
            '/assets/images/screenshots/screenshot_props_03.png',
            '/assets/images/screenshots/screenshot_props_04.png'
        ];
